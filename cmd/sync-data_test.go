...
func TestHiddenPluginsToAlert(t *testing.T) {
	...
	mk("plugins/affiliate-wp/affiliate-wp.php", "<?php $all_plugins = get_plugins(); // reads the list, never filters it")
	...
	if len(skipped) != 2 || !strings.Contains(skipped[0], "Flywheel") || !strings.Contains(skipped[1], "never hooks") {
